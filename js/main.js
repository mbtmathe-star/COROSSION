...
(function(){
 ...
 const targets=document.querySelectorAll(
   ".section-header, .value-card, .offer-item, .offer-image-panel, .industry-card, .cert-card, .about-image, .about-copy, .testimonial-tile, .contact-form-card, .contact-info-card, .process-diagram"
 );
